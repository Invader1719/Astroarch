...
{% if task.source or task.grade %}
\textit{ ({% if task.source %}{{ task.source.name }}{% if task.source.round %}, {{ task.source.round }}{% endif %}{% if task.source.year %}, {{ task.source.year }}{% endif %}{% endif %}{% if task.grade %}, {{ task.grade }} класс{% endif %}) }
{% endif %}
